...
interface BudgetViewProps {
  ...
  isPremium?: boolean;
  onShowUpgrade?: () => void;
  maxCalculatorBudget?: number; // New Prop: Limit from backend
}

const BudgetView: React.FC<BudgetViewProps> = ({ categories, setCategories, totalBudget, setTotalBudget, isPremium = false, onShowUpgrade, maxCalculatorBudget = 0 }) => {
