...
import { Check, CreditCard, Download, ShieldCheck, RefreshCw, FileText, X, Receipt, ExternalLink } from "lucide-react";
                        ...
                        <table className="w-full caption-bottom text-sm text-left">
                            <thead className="[&_tr]:border-b">
                                <tr className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                                    <th className="h-12 px-4 align-middle font-medium text-muted-foreground">ID Factură</th>
                                ...
                                {payments.map((payment, idx) => (
                                    <tr key={idx} className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                                        <td className="p-4 align-middle font-mono text-xs text-muted-foreground">
                                            {payment.invoiceId ? payment.invoiceId.slice(-8) : "N/A"}
                                        </td>
                        ...
                        <div className="bg-zinc-50/50 dark:bg-zinc-900/50 p-6 space-y-4">
                            ...
                            <div className="flex flex-col gap-3 mt-8">
                                ...
                                <Button 
                                    ...
                                    onClick={() => selectedPayment.hostedInvoiceUrl && window.open(selectedPayment.hostedInvoiceUrl, '_blank')}
                                    disabled={!selectedPayment.hostedInvoiceUrl}
                                >
