...
import { BOY_THEMES, getRomanticTheme } from './castleDefaults';
...
// ── Main Template ─────────────────────────────────────────────────────────────
const CastleMagicTemplateRomantic: React.FC<InvitationTemplateProps & {
  editMode?: boolean;
  ...
  const theme = getRomanticTheme(activeColorTheme);
...
export default CastleMagicTemplateRomantic;
